...
function useDebouncedCallback(callback, options) {
  ...
  const flushRef = reactExports.useRef(() => {
  });
...
function useMove(onChange, handlers, dir = "ltr") {
  const ref = reactExports.useRef(null);
  const mounted = reactExports.useRef(false);
  const isSliding = reactExports.useRef(false);
      ...
      frame.current = requestAnimationFrame(() => {
        if (mounted.current && node) {
          ...
          if (rect.width && rect.height) {
            const _x = clamp$2((x2 - rect.left) / rect.width, 0, 1);
            onChange({
              x: dir === "ltr" ? _x : 1 - _x,
              y: clamp$2((y2 - rect.top) / rect.height, 0, 1)
            });
          }
        }
      });
...
function useShallowEffect(cb2, dependencies) {
  reactExports.useEffect(cb2, useShallowCompare(dependencies));
}
...
const ScrollAreaRoot = reactExports.forwardRef((_props, ref) => {
  const props = useProps("ScrollAreaRoot", defaultProps$18, _props);
...
const ScrollAreaThumb = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    if (forceMount || scrollbarContext.hasThumb) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Thumb$1, { ref: forwardedRef, ...thumbProps });
    }
    return null;
  }
);
  ...
  ({ children, style, ...others }, ref) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Box,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { minWidth: "100%" }, ref: ctx.onContentChange, children })
      }
    );
  }
);
ScrollAreaViewport.displayName = "@mantine/core/ScrollAreaViewport";
var classes$z = { "root": "m_d57069b5", "viewport": "m_c0783ff9", "viewportInner": "m_f8f631dd", "scrollbar": "m_c44ba933", "thumb": "m_d8b5e363", "corner": "m_21657268" };
...
const ScrollArea = factory((_props, ref) => {
  const props = useProps("ScrollArea", defaultProps$17, _props);
  const {
    classNames,
    className,
    style,
...
const ScrollAreaAutosize = factory((props, ref) => {
  const {
    ...
    onTopReached,
    ...others
  } = useProps("ScrollAreaAutosize", defaultProps$17, props);
...
const UnstyledButton = polymorphicFactory(
  (_props, ref) => {
    const props = useProps("UnstyledButton", defaultProps$16, _props);
    const {
      className,
      component = "button",
      __staticSelector,
...
const VisuallyHidden = factory((_props, ref) => {
  const props = useProps("VisuallyHidden", defaultProps$15, _props);
...
const Paper = polymorphicFactory((_props, ref) => {
  const props = useProps("Paper", defaultProps$14, _props);
  const {
    classNames,
    className,
    style,
...
const Portal = factory((props, ref) => {
  const { children, target, reuseTargetNode, ...others } = useProps("Portal", defaultProps$12, props);
  const [mounted, setMounted] = reactExports.useState(false);
...
const PopoverDropdown = factory((_props, ref) => {
  const props = useProps("PopoverDropdown", defaultProps$11, _props);
  const {
    className,
    style,
    vars,
...
const varsResolver$z = createVarsResolver((theme2, { size: size2, color }) => ({
  root: {
...
const Loader = factory((_props, ref) => {
  const props = useProps("Loader", defaultProps$_, _props);
  const {
    size: size2,
    color,
    type,
...
const ActionIconGroup = factory((_props, ref) => {
  const props = useProps("ActionIconGroup", defaultProps$Z, _props);
  const {
    className,
    style,
    classNames,
    ...
    mod,
    ...others
  } = useProps("ActionIconGroup", defaultProps$Z, _props);
  const getStyles = useStyles({
...
const ActionIconGroupSection = factory((_props, ref) => {
  const props = useProps("ActionIconGroupSection", defaultProps$Y, _props);
  const {
    className,
    style,
    classNames,
    ...
    autoContrast,
    ...others
  } = useProps("ActionIconGroupSection", defaultProps$Y, _props);
  const getStyles = useStyles({
...
const ActionIcon = polymorphicFactory((_props, ref) => {
  const props = useProps("ActionIcon", defaultProps$X, _props);
  const {
    className,
    unstyled,
    variant,
...
const CloseButton = polymorphicFactory((_props, ref) => {
  const props = useProps("CloseButton", defaultProps$W, _props);
  const {
    iconSize,
    children,
    vars,
...
const Group = factory((_props, ref) => {
  const props = useProps("Group", defaultProps$V, _props);
  const {
    classNames,
    className,
    style,
...
const InputClearButton = factory((_props, ref) => {
  const props = useProps("InputClearButton", defaultProps$U, _props);
...
var classes$p = { "wrapper": "m_6c018570", "input": "m_8fb7ebe7", "section": "m_82577fc2", "placeholder": "m_88bacfd0", "root": "m_46b77525", "label": "m_8fdc1311", "required": "m_78a94662", "error": "m_8f816625", "description": "m_fe47ce59" };
...
const InputDescription = factory((_props, ref) => {
  const props = useProps("InputDescription", defaultProps$T, _props);
  const {
    classNames,
    className,
    style,
    ...
    variant,
    ...others
  } = useProps("InputDescription", defaultProps$T, props);
...
InputDescription.classes = classes$p;
...
const InputError = factory((_props, ref) => {
  const props = useProps("InputError", defaultProps$S, _props);
  const {
    classNames,
    className,
    style,
...
const InputLabel = factory((_props, ref) => {
  const props = useProps("InputLabel", defaultProps$R, _props);
  const {
    classNames,
    className,
    style,
    ...
    mod,
    ...others
  } = useProps("InputLabel", defaultProps$R, props);
  const _getStyles = useStyles({
    name: ["InputWrapper", __staticSelector],
    props,
    classes: classes$p,
...
InputLabel.classes = classes$p;
InputLabel.displayName = "@mantine/core/InputLabel";
const defaultProps$Q = {};
const InputPlaceholder = factory((_props, ref) => {
  const props = useProps("InputPlaceholder", defaultProps$Q, _props);
  const {
    classNames,
    className,
    style,
    ...
    mod,
    ...others
  } = useProps("InputPlaceholder", defaultProps$Q, props);
  const getStyles = useStyles({
...
InputPlaceholder.classes = classes$p;
...
const InputWrapper = factory((_props, ref) => {
  const props = useProps("InputWrapper", defaultProps$P, _props);
  const {
    classNames,
    className,
    style,
...
InputWrapper.classes = classes$p;
...
const Input = polymorphicFactory((_props, ref) => {
  const props = useProps("Input", defaultProps$O, _props);
  const {
    classNames,
    className,
    style,
...
const InputBase = polymorphicFactory((props, ref) => {
  const { inputProps, wrapperProps, ...others } = useInputProps("InputBase", defaultProps$N, props);
...
const FloatingIndicator = factory((_props, ref) => {
  const props = useProps("FloatingIndicator", defaultProps$M, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { ref: mergedRef, mod: [{ initialized, hidden: hidden2 }, mod], ...getStyles("root"), ...others });
});
...
const Alert = factory((_props, ref) => {
  const props = useProps("Alert", defaultProps$L, _props);
  const {
    classNames,
    className,
    style,
...
var classes$l = { "dropdown": "m_88b62a41", "search": "m_985517d8", "options": "m_b2821a6e", "option": "m_92253aa5", "empty": "m_2530cd1d", "header": "m_858f94bd", "footer": "m_82b967cb", "group": "m_254f3e4f", "groupLabel": "m_2bb2e9e5", "chevron": "m_2943220b", "optionsDropdownOption": "m_390b5f4", "optionsDropdownCheckIcon": "m_8ee53fc2" };
const defaultProps$J = {
  error: null
};
const varsResolver$l = createVarsResolver((theme2, { size: size2, color }) => ({
  chevron: {
...
const ComboboxChevron = factory((_props, ref) => {
  const props = useProps("ComboboxChevron", defaultProps$J, _props);
...
ComboboxChevron.classes = classes$l;
...
ComboboxDropdown.classes = classes$l;
ComboboxDropdown.displayName = "@mantine/core/ComboboxDropdown";
const defaultProps$H = {
  refProp: "ref"
};
const ComboboxDropdownTarget = factory((props, ref) => {
  const { children, refProp } = useProps("ComboboxDropdownTarget", defaultProps$H, props);
  useComboboxContext();
  if (!isElement$1(children)) {
    throw new Error(
...
ComboboxEmpty.classes = classes$l;
...
const ComboboxEventsTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxEventsTarget", defaultProps$F, props);
  if (!isElement$1(children)) {
    throw new Error(
...
ComboboxFooter.classes = classes$l;
...
const ComboboxGroup = factory((props, ref) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Box,
    {
      ...
      ...others,
      children: [
        label && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...ctx.getStyles("groupLabel", { classNames, styles }), children: label }),
        children
      ]
    }
  );
});
ComboboxGroup.classes = classes$l;
...
ComboboxHeader.classes = classes$l;
...
const ComboboxOption = factory((_props, ref) => {
  const props = useProps("ComboboxOption", defaultProps$B, _props);
  const {
    classNames,
    className,
    style,
...
ComboboxOption.classes = classes$l;
ComboboxOption.displayName = "@mantine/core/ComboboxOption";
const defaultProps$A = {};
const ComboboxOptions = factory((_props, ref) => {
  const props = useProps("ComboboxOptions", defaultProps$A, _props);
  const { classNames, className, style, styles, id: id2, onMouseDown, labelledBy, ...others } = props;
  const ctx = useComboboxContext();
  const _id = useId$1(id2);
  reactExports.useEffect(() => {
...
ComboboxOptions.classes = classes$l;
...
const ComboboxSearch = factory((_props, ref) => {
  const props = useProps("ComboboxSearch", defaultProps$z, _props);
  const {
    classNames,
    styles,
    unstyled,
...
ComboboxSearch.classes = classes$l;
...
const ComboboxTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxTarget", defaultProps$y, props);
  if (!isElement$1(children)) {
    throw new Error(
...
function useCombobox({
    ...
    (target = "selected", options) => {
      selectedIndexUpdateTimeout.current = window.setTimeout(() => {
        ...
        if (options?.scrollIntoView) {
          items[index2]?.scrollIntoView({ block: "nearest", behavior: scrollBehavior });
        }
      }, 0);
    },
    []
  ...
  const setListId = reactExports.useCallback((id2) => {
    listId.current = id2;
  }, []);
...
function Combobox(_props) {
  const props = useProps("Combobox", defaultProps$x, _props);
  const {
    classNames,
    styles,
    unstyled,
...
var classes$k = { "root": "m_5f75b09e", "body": "m_5f6e695e", "labelWrapper": "m_d3ea56bb", "label": "m_8ee546b8", "description": "m_328f68c0", "error": "m_8e8a99cc" };
const InlineInputClasses = classes$k;
      ...
      Box,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Box,
          {
            ...
            htmlFor: bodyElement === "label" ? id2 : void 0,
            ...getStyles("body"),
            children: [
              children,
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ...getStyles("labelWrapper"), "data-disabled": disabled || void 0, children: [
                label && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ...
                  {
                    component: labelElement,
                    htmlFor: labelElement === "label" ? id2 : void 0,
                    ...getStyles("label"),
...
function Option({
  ...
  if (!isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, { className: classes$l.optionsDropdownCheckIcon });
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Combobox.Option,
      {
        ...
        className: clsx({ [classes$l.optionsDropdownOption]: !unstyled }),
...
function OptionsDropdown({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, "data-composed": true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
...
const Badge = polymorphicFactory((_props, ref) => {
  const props = useProps("Badge", defaultProps$w, _props);
  const {
    classNames,
    className,
    style,
...
const varsResolver$i = createVarsResolver((_, { borderWidth }) => ({
  group: { "--button-border-width": rem(borderWidth) }
}));
const ButtonGroup = factory((_props, ref) => {
  const props = useProps("ButtonGroup", defaultProps$v, _props);
  const {
    className,
    style,
    classNames,
    ...
    mod,
    ...others
  } = useProps("ButtonGroup", defaultProps$v, _props);
  const getStyles = useStyles({
    name: "ButtonGroup",
    props,
    classes: classes$i,
...
const ButtonGroupSection = factory((_props, ref) => {
  const props = useProps("ButtonGroupSection", defaultProps$u, _props);
  const {
    className,
    style,
    classNames,
    ...
    autoContrast,
    ...others
  } = useProps("ButtonGroupSection", defaultProps$u, _props);
  const getStyles = useStyles({
...
const Button = polymorphicFactory((_props, ref) => {
  const props = useProps("Button", defaultProps$t, _props);
  const {
    style,
    vars,
    className,
...
var classes$h = { "root": "m_e615b15f", "section": "m_599a2148" };
const defaultProps$s = {};
const CardSection = polymorphicFactory((_props, ref) => {
  const props = useProps("CardSection", defaultProps$s, _props);
...
CardSection.classes = classes$h;
CardSection.displayName = "@mantine/core/CardSection";
const defaultProps$r = {};
const varsResolver$f = createVarsResolver((_, { padding }) => ({
  root: {
    "--card-padding": getSpacing(padding)
  }
}));
const Card = polymorphicFactory((_props, ref) => {
  const props = useProps("Card", defaultProps$r, _props);
  ...
  const content2 = _children.map((child, index2) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CardProvider, { value: { getStyles }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Paper, { ref, unstyled, ...getStyles("root"), ...others, children: content2 }) });
});
Card.classes = classes$h;
Card.displayName = "@mantine/core/Card";
Card.Section = CardSection;
var classes$g = { "root": "m_4451eb3a" };
const defaultProps$q = {};
const Center = polymorphicFactory((_props, ref) => {
  const props = useProps("Center", defaultProps$q, _props);
...
var classes$f = { "root": "m_b183c0a2" };
const defaultProps$p = {};
const varsResolver$e = createVarsResolver((theme2, { color }) => ({
  root: {
    "--code-bg": color ? getThemeColor(color, theme2) : void 0
  }
}));
const Code = factory((_props, ref) => {
  const props = useProps("Code", defaultProps$p, _props);
  const {
    classNames,
    className,
    style,
...
Code.classes = classes$f;
Code.displayName = "@mantine/core/Code";
var classes$e = { "root": "m_7485cace" };
const defaultProps$o = {};
const varsResolver$d = createVarsResolver((_, { size: size2, fluid }) => ({
  root: {
    "--container-size": fluid ? void 0 : getSize(size2, "container-size")
  }
}));
const Container = factory((_props, ref) => {
  const props = useProps("Container", defaultProps$o, _props);
...
Container.classes = classes$e;
Container.displayName = "@mantine/core/Container";
var classes$d = { "root": "m_3eebeb36", "label": "m_9e365f20" };
const defaultProps$n = {
  orientation: "horizontal"
};
const varsResolver$c = createVarsResolver((theme2, { color, variant, size: size2 }) => ({
  root: {
...
const Divider = factory((_props, ref) => {
  const props = useProps("Divider", defaultProps$n, _props);
  const {
    classNames,
    className,
    style,
...
var classes$c = { "container": "m_8478a6da", "root": "m_410352e9", "inner": "m_dee7bd2f", "col": "m_96bdd299" };
const defaultProps$m = {
  span: 12
};
const GridCol = factory((_props, ref) => {
  const props = useProps("GridCol", defaultProps$m, _props);
...
const varsResolver$b = createVarsResolver((_, { justify, align, overflow }) => ({
  root: {
...
const Grid = factory((_props, ref) => {
  const props = useProps("Grid", defaultProps$l, _props);
  const {
    classNames,
    className,
    style,
  ...
  if (type === "container" && breakpoints) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(GridProvider, { value: { getStyles, grow, columns: columns || 12, breakpoints, type }, children: [
...
Grid.classes = classes$c;
Grid.displayName = "@mantine/core/Grid";
Grid.Col = GridCol;
const [ListProvider, useListContext] = createSafeContext(
  "List component was not found in tree"
);
var classes$b = { "root": "m_abbac491", "item": "m_abb6bec2", "itemWrapper": "m_75cd9f71", "itemIcon": "m_60f83e5b" };
const defaultProps$k = {};
const ListItem = factory((_props, ref) => {
  const props = useProps("ListItem", defaultProps$k, _props);
...
ListItem.classes = classes$b;
ListItem.displayName = "@mantine/core/ListItem";
const defaultProps$j = {
  type: "unordered"
};
const varsResolver$a = createVarsResolver((_, { size: size2, spacing }) => ({
  root: {
...
const List = factory((_props, ref) => {
  const props = useProps("List", defaultProps$j, _props);
  const {
    classNames,
    className,
    style,
...
List.classes = classes$b;
List.displayName = "@mantine/core/List";
List.Item = ListItem;
const [ProgressProvider, useProgressContext] = createSafeContext(
  "Progress.Root component was not found in tree"
);
var classes$a = { "root": "m_db6d6462", "section": "m_2242eb65", "stripes-animation": "m_81a374bd", "label": "m_91e40b74" };
const defaultProps$i = {};
...
ProgressLabel.classes = classes$a;
...
const ProgressRoot = factory((_props, ref) => {
  const props = useProps("ProgressRoot", defaultProps$h, _props);
  const {
    classNames,
    className,
    style,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressProvider, { value: { getStyles, autoContrast }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { ref, ...getStyles("root"), ...others }) });
});
ProgressRoot.classes = classes$a;
...
const ProgressSection = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("ProgressSection", defaultProps$g, props);
  const ctx = useProgressContext();
  const theme2 = useMantineTheme();
  const ariaAttributes = withAria ? {
    role: "progressbar",
...
function useFloatingTooltip({
  ...
  const { x: x2, y: y2, elements, refs, update, placement } = useFloating({
    placement: position,
    middleware: [
      shift({
        crossAxis: true,
...
const varsResolver$8 = createVarsResolver((theme2, { radius, color }) => ({
  tooltip: {
...
const varsResolver$7 = createVarsResolver((theme2, { radius, color }) => ({
  tooltip: {
    "--tooltip-radius": radius === void 0 ? void 0 : getRadius(radius),
    "--tooltip-bg": color ? getThemeColor(color, theme2) : void 0,
    "--tooltip-color": color ? "var(--mantine-color-white)" : void 0
...
const SegmentedControl = factory((_props, ref) => {
  const props = useProps("SegmentedControl", defaultProps$b, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [key, setKey] = reactExports.useState(randomId());
  ...
  const controls = _data.map((item) => /* @__PURE__ */ reactExports.createElement(
    ...
    /* @__PURE__ */ reactExports.createElement(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { ...getStyles("innerLabel"), children: item.label })
    )
  ));
...
var classes$7 = { "container": "m_925c2d2c", "root": "m_2415a157" };
...
const SliderRoot = reactExports.forwardRef(
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Transition,
            {
              ...
              duration: 0,
              ...labelTransitionProps,
              children: (transitionStyles) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...getStyles("label", { style: transitionStyles }), children: label })
            }
          )
        ]
      }
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset2, inverted }) {
  ...
  const items = marks.map((mark, index2) => /* @__PURE__ */ reactExports.createElement(
    ...
    mark.label && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...getStyles("markLabel"), children: mark.label })
  ));
...
function Track({
  ...
  const { getStyles } = useSliderContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { ...getStyles("trackContainer"), mod: { disabled }, ...containerProps, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { ...getStyles("track"), mod: { inverted, disabled }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Box,
      {
...
var classes$6 = { "root": "m_dd36362e", "label": "m_c9357328", "thumb": "m_c9a9a60a", "trackContainer": "m_a8645c2", "track": "m_c9ade57f", "bar": "m_38aeed47", "markWrapper": "m_b7b0423a", "mark": "m_dd33bc19", "markLabel": "m_68c77a5b" };
...
const varsResolver$5 = createVarsResolver(
  (theme2, { size: size2, color, thumbSize, radius }) => ({
    root: {
      "--slider-size": getSize(size2, "slider-size"),
      "--slider-color": color ? getThemeColor(color, theme2) : void 0,
...
const Slider = factory((_props, ref) => {
  const props = useProps("Slider", defaultProps$8, _props);
  const {
    classNames,
    styles,
    value,
  ...
  const valueRef = reactExports.useRef(_value);
  const onChangeEndRef = reactExports.useRef(onChangeEnd);
  reactExports.useEffect(() => {
    onChangeEndRef.current = onChangeEnd;
  }, [onChangeEnd]);
  const root = reactExports.useRef(null);
  const thumb = reactExports.useRef(null);
  ...
  const handleScrubEnd = reactExports.useCallback(() => {
  ...
  const { ref: container2, active } = useMove(handleChange, { onScrubEnd: handleScrubEnd }, dir);
  const callOnChangeEnd = reactExports.useCallback(
    (value2) => {
      if (!disabled && onChangeEndRef.current) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SliderProvider, { value: { getStyles }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SliderRoot,
    {
      ...others,
...
const varsResolver$4 = createVarsResolver((_, { gap, align, justify }) => ({
  root: {
...
const StepperStep = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("StepperStep", defaultProps$6, props);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    UnstyledButton,
    {
      ...
      ...dataAttributes,
      ...others,
      __vars: { "--step-color": color ? getThemeColor(color, theme2) : void 0 },
...
const varsResolver$3 = createVarsResolver(
  (theme2, { color, iconSize, size: size2, contentPadding, radius, autoContrast }) => ({
    root: {
      "--stepper-color": color ? getThemeColor(color, theme2) : void 0,
      "--stepper-icon-color": getAutoContrastValue(autoContrast, theme2) ? getContrastColor({ color, theme: theme2, autoContrast }) : void 0,
...
const Stepper = factory((_props, ref) => {
  const props = useProps("Stepper", defaultProps$5, _props);
  const {
    classNames,
    className,
    style,
    ...
    (acc, item, index2) => {
      ...
      acc.push(
        reactExports.cloneElement(item, {
          ...
          step: index2,
          state,
          onClick: () => isStepSelectionEnabled && onStepClick?.(index2),
  ...
  const content2 = active > _children.length - 1 ? completedContent : stepContent;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(StepperProvider, { value: { getStyles, orientation, iconPosition }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { ...getStyles("root"), ref, size: size2, ...others, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Box,
      {
        ...getStyles("steps"),
    ...
    content2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ...getStyles("content"), children: content2 })
  ] }) });
});
Stepper.classes = classes$4;
...
const SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size2, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", defaultProps$4, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    Input.Wrapper,
    {
      size: size2,
      ref,
...
var classes$3 = { "root": "m_5f93f3bb", "input": "m_926b4011", "track": "m_9307d992", "thumb": "m_93039a1d", "trackLabel": "m_8277e082" };
const defaultProps$3 = {
  labelPosition: "right"
};
const varsResolver$2 = createVarsResolver((theme2, { radius, color, size: size2 }) => ({
  root: {
    ...
    "--switch-color": color ? getThemeColor(color, theme2) : void 0
  }
}));
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Box,
          {
            ...
            ...getStyles("track"),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { component: "span", mod: "reduce-motion", ...getStyles("thumb"), children: thumbIcon }),
...
Switch.classes = { ...classes$3, ...InlineInputClasses };
...
const ALL_AXES = ["LeftX", "LeftY", "RightX", "RightY", "L2", "R2"];
...
function useConfig() {
  ...
  const latest = reactExports.useRef(null);
  ...
  const updateProfileById = reactExports.useCallback(
    (id2, mut) => {
      apply((c) => ({
        ...c,
        profiles: c.profiles.map((p2) => p2.id === id2 ? mut(p2) : p2)
      }));
    },
    [apply]
  );
  const updateProfile = reactExports.useCallback(
    (mut) => {
      const id2 = latest.current?.activeProfileId ?? DEFAULT_PROFILE_ID;
      updateProfileById(id2, mut);
    },
    [updateProfileById]
  );
  ...
  const setPaths = reactExports.useCallback(
    (paths) => {
  ...
  const setActiveProfileId = reactExports.useCallback(
    (id2) => apply((c) => ({ ...c, activeProfileId: id2 })),
    [apply]
  );
  const patchConfig = reactExports.useCallback(
    (patch) => apply((c) => ({ ...c, ...patch })),
    [apply]
  );
  const activeProfile = reactExports.useMemo(() => {
    if (!config) return null;
    return config.profiles.find((p2) => p2.id === config.activeProfileId) ?? config.profiles[0] ?? null;
  }, [config]);
  reactExports.useEffect(() => {
    return () => {
      void flush();
...
function useControllerFeed() {
  const [state, setState] = reactExports.useState(emptyControllerState);
  reactExports.useEffect(() => {
...
function useRuntime() {
  const [runtime, setRuntime] = reactExports.useState(INITIAL_RUNTIME);
  reactExports.useEffect(() => {
    let alive = true;
    void window.claudepad.getRuntime().then((status) => {
  ...
  const setArmed = reactExports.useCallback((armed) => {
...
function OnboardingPage({
  ...
  const [perms, setPerms] = reactExports.useState(null);
  const [checkingPerms, setCheckingPerms] = reactExports.useState(false);
  ...
  const next = () => setActive((s) => Math.min(STEPS - 1, s + 1));
  ...
  const isMac2 = perms?.platform === "darwin";
  const needsAccessibility = isMac2 && perms !== null && !perms.accessibility;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Center, { mih: "100vh", p: "xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { size: "sm", w: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 4, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 2, children: "Welcome to ClaudePad" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "A quick setup so your controller can drive Claude." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Stepper, { active, onStepClick: setActive, size: "sm", allowNextStepsSelect: false, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stepper.Step, { label: "Welcome", description: "What this is", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", mt: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 3, children: "Drive Claude with a controller" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { children: "ClaudePad maps your PS4 / DualShock controller to Claude Desktop, Claude Code (CLI), and your OS — send messages, switch models, scroll, and move the cursor without touching the keyboard." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "Next we'll grant a permission, pair your controller, and (optionally) point at your apps." })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stepper.Step, { label: "Permissions", description: "Allow input control", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", mt: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 3, children: "Accessibility permission" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { size: "sm", children: [
          "To press keys and move the mouse on your behalf, ClaudePad needs the OS to trust it. On macOS that's the",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Accessibility" }),
          " permission."
        ] }),
        checkingPerms && /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { size: "xs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", c: "dimmed", children: "Checking permissions…" })
        ] }),
        perms && !isMac2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { color: "green", variant: "light", title: "You're all set", children: [
          "No extra permission is required on ",
          perms.platform,
          "."
        ] }),
        perms && isMac2 && perms.accessibility && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "green", variant: "light", title: "Accessibility granted", children: "ClaudePad can control input. You're good to go." }),
        needsAccessibility && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "yellow", variant: "light", title: "Accessibility not granted yet", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "Open System Settings and enable ClaudePad under Privacy & Security → Accessibility. You can continue setup now and grant it afterward." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: "Open Accessibility Settings"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stepper.Step, { label: "Controller", description: "Pair it", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", mt: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 3, children: "Connect your controller" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { size: "sm", children: [
          "Plug in via USB or pair over Bluetooth. The background service detects it automatically — ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "no button press needed" }),
          "."
        ] }),
        connected ? /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "green", variant: "light", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeIcon, { color: "green", radius: "xl", size: "sm", children: "✓" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 0, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { fw: 600, size: "sm", children: "Controller connected" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", children: controllerName || "Gamepad detected" })
          ] })
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "gray", variant: "light", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { size: "xs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "Waiting for a controller…" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", children: "No controller? You can still continue and pair later — the Tester page will show it live." })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stepper.Step, { label: "Apps", description: "Optional", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", mt: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 3, children: "Point at your apps (optional)" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: 'Set these so the "Launch" actions can open the right app. You can skip and configure them later in Settings.' }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(List, { spacing: "sm", size: "sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(List.Item, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: "Choose Claude Desktop…"
                }
              ),
              config.paths.claudeDesktop ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "light", color: "green", children: "Set" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", children: "Not set" })
            ] }),
            config.paths.claudeDesktop && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", style: { wordBreak: "break-all" }, children: config.paths.claudeDesktop })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(List.Item, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  children: "Choose terminal…"
                }
              ),
              config.paths.terminal ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "light", color: "green", children: "Set" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", children: "Not set" })
            ] }),
            config.paths.terminal && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", style: { wordBreak: "break-all" }, children: config.paths.terminal })
          ] })
        ] })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Stepper.Completed, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", mt: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", align: "center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeIcon, { color: "clay", size: 56, radius: "xl", children: "✓" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 3, children: "You're ready" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { ta: "center", c: "dimmed", size: "sm", children: "A default mapping is already loaded. Head to the Tester to feel out sensitivity, or the Mapper to customize what each button does." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "md", onClick: onComplete, children: "Enter ClaudePad" })
      ] }) }) })
    ] }),
    active < STEPS - 1 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "subtle", onClick: back, disabled: active === 0, children: "Back" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: next, children: active === STEPS - 2 ? "Finish" : "Continue" })
    ] }) : null
  ] }) }) });
}
...
function getAction(id2) {
  return CATALOG_INDEX[id2];
}
...
function shapeAxis(v2, sens) {
  const sign = Math.sign(v2);
  const mag = Math.abs(v2);
...
function ControllerVisual({
  ...
  const theme2 = useMantineTheme();
  const accent = theme2.colors.clay[5];
  const accentDim = theme2.colors.clay[8];
  const idle = "#3a3d44";
  const idleStroke = "#4c505a";
  const body = "#26282e";
  const bodyStroke = "#3a3d44";
  const label = "#c9ccd3";
  const on = (id2) => state.buttons[id2];
  const fill = (id2) => on(id2) ? accent : idle;
  const stroke = (id2) => on(id2) ? accent : idleStroke;
  const clamp2 = (v2) => Math.max(-1, Math.min(1, v2)) * stickTravel;
  const lx = clamp2(state.axes.LeftX);
  const ly = clamp2(state.axes.LeftY);
  const rx = clamp2(state.axes.RightX);
  const ry = clamp2(state.axes.RightY);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      viewBox: "0 0 460 300",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "86", y: "70", width: "70", height: "18", rx: "9", fill: fill("L1"), stroke: stroke("L1"), strokeWidth: 2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "121", y: "83", fontSize: "11", fill: label, textAnchor: "middle", children: "L1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "304", y: "70", width: "70", height: "18", rx: "9", fill: fill("R1"), stroke: stroke("R1"), strokeWidth: 2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "339", y: "83", fontSize: "11", fill: label, textAnchor: "middle", children: "R1" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "96", y: "48", width: "52", height: "18", rx: "6", fill: idle, stroke: idleStroke, strokeWidth: 2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: "96",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "122", y: "61", fontSize: "11", fill: label, textAnchor: "middle", children: "L2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "312", y: "48", width: "52", height: "18", rx: "6", fill: idle, stroke: idleStroke, strokeWidth: 2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: "312",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "338", y: "61", fontSize: "11", fill: label, textAnchor: "middle", children: "R2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "94", y: "118", width: "20", height: "20", rx: "3", fill: fill("DpadUp"), stroke: stroke("DpadUp"), strokeWidth: 1.5 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "94", y: "160", width: "20", height: "20", rx: "3", fill: fill("DpadDown"), stroke: stroke("DpadDown"), strokeWidth: 1.5 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "72", y: "140", width: "20", height: "20", rx: "3", fill: fill("DpadLeft"), stroke: stroke("DpadLeft"), strokeWidth: 1.5 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "116", y: "140", width: "20", height: "20", rx: "3", fill: fill("DpadRight"), stroke: stroke("DpadRight"), strokeWidth: 1.5 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "346", cy: "128", r: "13", fill: fill("Triangle"), stroke: stroke("Triangle"), strokeWidth: 2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "346", y: "132", fontSize: "12", fill: label, textAnchor: "middle", children: "△" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "372", cy: "150", r: "13", fill: fill("Circle"), stroke: stroke("Circle"), strokeWidth: 2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "372", y: "154", fontSize: "12", fill: label, textAnchor: "middle", children: "○" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "346", cy: "172", r: "13", fill: fill("Cross"), stroke: stroke("Cross"), strokeWidth: 2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "346", y: "176", fontSize: "12", fill: label, textAnchor: "middle", children: "✕" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "320", cy: "150", r: "13", fill: fill("Square"), stroke: stroke("Square"), strokeWidth: 2 }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("text", { x: "320", y: "154", fontSize: "12", fill: label, textAnchor: "middle", children: "□" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "176", y: "118", width: "14", height: "20", rx: "3", fill: fill("Share"), stroke: stroke("Share"), strokeWidth: 1.5 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("rect", { x: "270", y: "118", width: "14", height: "20", rx: "3", fill: fill("Options"), stroke: stroke("Options"), strokeWidth: 1.5 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "rect",
          {
            x: "196",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "230", cy: "176", r: "9", fill: fill("PS"), stroke: stroke("PS"), strokeWidth: 1.5 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "176", cy: "200", r: "24", fill: "#1d1f24", stroke: bodyStroke, strokeWidth: 2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: 176 + lx,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "284", cy: "200", r: "24", fill: "#1d1f24", stroke: bodyStroke, strokeWidth: 2 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "circle",
          {
            cx: 284 + rx,
...
function TesterPage({
  ...
  const RawShaped = ({ label, id: id2 }) => {
    const raw = state.axes[id2];
    const shaped = shapeAxis(raw, sens);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", gap: "xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", w: 56, c: "dimmed", children: label }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", ff: "monospace", w: 70, ta: "right", children: fmt(raw) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", children: "→" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", ff: "monospace", w: 70, ta: "right", c: "clay.4", fw: 600, children: fmt(shaped) })
    ] });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", align: "flex-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 2, children: "Tester" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "Check your controls, tune sensitivity, and see the shaping in action." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Tooltip,
        {
          label: armed ? "Output is LIVE — inputs will actuate your OS." : "Output is off — safe to test without sending input.",
          withArrow: true,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Switch,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "gray", variant: "light", title: "Input runs in the background", children: "Input is read by the background service — it keeps working when you switch to Claude. Nothing is sent to your OS unless output is armed." }),
    armed && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "red", variant: "light", title: "Output armed", children: "Button presses and stick motion are now being sent to your system." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Grid, { gutter: "lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Grid.Col, { span: { base: 12, md: 6 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", h: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Live controller" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { color: connected ? "green" : "gray", variant: "light", children: connected ? "Connected" : "No controller" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ControllerVisual, { state }),
        state.id && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", ta: "center", children: state.id })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Grid.Col, { span: { base: 12, md: 6 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", h: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "lg", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Sensitivity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 4, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "Deadzone" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", ff: "monospace", c: "dimmed", children: sens.deadzone.toFixed(2) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Slider,
            {
              ...
              step: 0.01,
              value: sens.deadzone,
              onChange: (v2) => onSensitivityChange({ deadzone: v2 }),
              color: "clay",
              label: (v2) => v2.toFixed(2)
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 4, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "Curve" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", ff: "monospace", c: "dimmed", children: sens.curve.toFixed(2) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Slider,
            {
              ...
              step: 0.05,
              value: sens.curve,
              onChange: (v2) => onSensitivityChange({ curve: v2 }),
              color: "clay",
              label: (v2) => v2.toFixed(2)
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 4, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "Trigger threshold" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", ff: "monospace", c: "dimmed", children: sens.triggerThreshold.toFixed(2) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Slider,
            {
              ...
              onChange: (v2) => onSensitivityChange({ triggerThreshold: v2 }),
              color: "clay",
              label: (v2) => v2.toFixed(2)
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "sm", bg: "dark.6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 6, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", fw: 600, children: "RAW" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "clay.4", fw: 600, children: "SHAPED" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RawShaped, { label: "Left X", id: "LeftX" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RawShaped, { label: "Left Y", id: "LeftY" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RawShaped, { label: "Right X", id: "RightX" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(RawShaped, { label: "Right Y", id: "RightY" })
        ] }) })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Buttons" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleGrid, { cols: { base: 3, sm: 4, md: 6 }, spacing: "xs", children: ALL_BUTTONS.map((b) => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Axes" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SimpleGrid, { cols: { base: 1, sm: 2, md: 3 }, spacing: "md", children: ALL_AXES.map((a) => {
        const v2 = state.axes[a];
        const isTrigger = a === "L2" || a === "R2";
        const pct = isTrigger ? v2 * 100 : (v2 + 1) * 50;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 4, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: a }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", ff: "monospace", c: "dimmed", children: fmt(v2) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Progress,
            {
...
function BindingRow({
  ...
  const actionGroups = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "sm", wrap: "nowrap", align: "center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Badge,
      {
        size: "lg",
        ...
        children: inputLabel(binding.input)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Select,
      {
        ...
        onChange: (val) => val && onChange({ ...binding, trigger: val }),
        allowDeselect: false,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Select,
      {
        ...
        error: !isKnown ? "Unknown action" : void 0
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { label: resolvedLabel, withArrow: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", color: "gray", radius: "sm", style: { minWidth: 130 }, children: resolvedCategory ?? "—" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { label: "Remove binding", withArrow: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ActionIcon,
      {
        variant: "subtle",
        color: "red",
...
function chordLabel(tokens) {
  return tokens.length ? tokens.map((t2) => SYMBOL[t2] ?? t2).join(" ") : "";
}
function eventToTokens(e) {
  ...
  const k2 = e.key;
  if (k2 === "Meta" || k2 === "Control" || k2 === "Alt" || k2 === "Shift") return null;
  let main = null;
  if (/^[a-zA-Z]$/.test(k2)) main = k2.toUpperCase();
  else if (/^[0-9]$/.test(k2)) main = k2;
  else if (/^F([1-9]|1[0-9])$/.test(k2)) main = k2;
  else if (SPECIAL[k2]) main = SPECIAL[k2];
  else if (k2 === "/") main = "/";
  else if (k2.length === 1) main = k2.toUpperCase();
  if (!main) return null;
  return [...mods, main];
}
function KeyCapture({
  ...
  const display = recording ? "Press a shortcut…" : value.length ? chordLabel(value) : "Click, then press keys";
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TextInput,
    {
      readOnly: true,
...
function MapperPage({
  ...
  const [addInput, setAddInput] = reactExports.useState(null);
  const updateBinding = (next) => {
    onUpdateProfile((p2) => ({
      ...p2,
      bindings: p2.bindings.map((b) => b.id === next.id ? next : b)
    }));
  };
  const removeBinding = (id2) => {
    onUpdateProfile((p2) => ({
      ...p2,
      bindings: p2.bindings.filter((b) => b.id !== id2)
    }));
  };
  const addBinding = () => {
    if (!addInput) return;
    ...
    onUpdateProfile((p2) => ({ ...p2, bindings: [...p2.bindings, binding] }));
    setAddInput(null);
  };
  const updateAxisMap = (id2, patch) => {
    onUpdateProfile((p2) => ({
      ...p2,
      axisMaps: p2.axisMaps.map((m2) => m2.id === id2 ? { ...m2, ...patch } : m2)
    }));
  };
  ...
  const addCustom = () => {
    ...
    onUpdateProfile((p2) => ({ ...p2, customActions: [...p2.customActions ?? [], ca2] }));
  };
  const updateCustom = (id2, patch) => {
    onUpdateProfile((p2) => ({
      ...p2,
      customActions: (p2.customActions ?? []).map((c) => c.id === id2 ? { ...c, ...patch } : c)
    }));
  };
  const removeCustom = (id2) => {
    onUpdateProfile((p2) => ({
      ...p2,
      customActions: (p2.customActions ?? []).filter((c) => c.id !== id2)
    }));
  };
  const orderedBindings = reactExports.useMemo(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", align: "flex-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 2, children: "Mapper" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "Map controller inputs to Claude options. Output is armed here." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Switch,
        {
    ...
    !enabled && /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { color: "gray", variant: "light", title: "Mapping disabled", children: [
      "The master switch is off — nothing is being sent. Turn on",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Enabled" }),
      " to make your controller drive Claude."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Button bindings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "light", color: "gray", children: [
          profile.bindings.length,
          " bound"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "sm", children: [
        orderedBindings.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          BindingRow,
          {
            binding: b,
            customActions,
        ...
        orderedBindings.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "No bindings yet — add one below." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "sm", align: "flex-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Select,
          {
            ...
            value: addInput,
            onChange: (v2) => setAddInput(v2),
            comboboxProps: { withinPortal: true },
            searchable: true,
            w: 240
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: addBinding, disabled: !addInput, children: "Add binding" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 2, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Custom commands" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { size: "sm", c: "dimmed", children: [
            "Make your own actions — type any text/snippet or fire any keyboard shortcut — then bind them to a button above (they appear under ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Custom" }),
            ")."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "light", color: "gray", children: customActions.length })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "sm", children: [
        customActions.map((ca2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "md", bg: "dark.6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "sm", wrap: "nowrap", align: "flex-end", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextInput,
              {
                label: "Name",
                value: ca2.label,
                onChange: (e) => updateCustom(ca2.id, { label: e.currentTarget.value }),
                style: { flex: 1 },
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              {
                value: ca2.kind,
                onChange: (v2) => updateCustom(ca2.id, { kind: v2 }),
                data: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ActionIcon,
              {
                variant: "subtle",
                color: "red",
                onClick: () => removeCustom(ca2.id),
                "aria-label": `Remove ${ca2.label}`,
                mb: 4,
                children: "✕"
              }
            )
          ] }),
          ca2.kind === "text" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "sm", wrap: "nowrap", align: "flex-end", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextInput,
              {
                label: "Text to type",
                ...
                value: ca2.text ?? "",
                onChange: (e) => updateCustom(ca2.id, { text: e.currentTarget.value }),
                style: { flex: 1 }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Switch,
              {
                label: "Press Enter",
                checked: !!ca2.submit,
                onChange: (e) => updateCustom(ca2.id, { submit: e.currentTarget.checked }),
                mb: 8
              }
            )
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 4, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "Shortcut" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              KeyCapture,
              {
                value: ca2.keys ?? [],
                onChange: (keys2) => updateCustom(ca2.id, { keys: keys2 })
              }
            )
          ] })
        ] }) }, ca2.id)),
        customActions.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "No custom commands yet — add one below." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "light", onClick: addCustom, children: "Add custom command" }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Analog sticks" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", c: "dimmed", children: "Choose what each stick controls and how fast." }),
      profile.axisMaps.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "md", bg: "dark.6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "light", color: "clay", radius: "sm", size: "lg", children: m2.source === "left" ? "Left stick" : "Right stick" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Select,
            {
              data: AXIS_TARGETS,
              value: m2.target,
              onChange: (v2) => v2 && updateAxisMap(m2.id, { target: v2 }),
              allowDeselect: false,
              comboboxProps: { withinPortal: true },
              w: 160
            }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 4, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "Speed" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", ff: "monospace", c: "dimmed", children: m2.speed.toFixed(0) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Slider,
            {
              ...
              step: 1,
              value: m2.speed,
              onChange: (v2) => updateAxisMap(m2.id, { speed: v2 }),
              color: "clay",
              label: (v2) => v2.toFixed(0)
            }
          )
        ] })
      ] }) }, m2.id)),
      profile.axisMaps.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "No stick mappings configured." })
    ] }) })
  ] });
}
function SettingsPage({
  ...
  const PathRow = ({
    ...
    label,
    value
  }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", wrap: "nowrap", align: "center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 2, style: { minWidth: 0, flex: 1 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", fw: 600, children: label }),
      value ? /* @__PURE__ */ jsxRuntimeExports.jsx(Code, { style: { wordBreak: "break-all" }, children: value }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", children: "Not set" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "light", size: "xs", onClick: () => void onPickPath(kind), children: value ? "Change…" : "Choose…" })
  ] });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 2, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 2, children: "Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "Master switch, app paths, and permissions." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", align: "center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Mapping" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", c: "dimmed", children: "When off, ClaudePad emits nothing — a global kill switch." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Switch,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", align: "center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 2, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Controller input" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { size: "sm", c: "dimmed", children: [
            "How ClaudePad reads the pad. Turn on to use the DS4 ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "touchpad" }),
            " as a trackpad."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      config.inputBackend === "hid" && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "blue", variant: "light", title: "Touchpad reader active", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Text, { size: "sm", children: [
        "The ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "left stick" }),
        " and the ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "touchpad" }),
        " now both move the cursor. For the touchpad you may be prompted for ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "Input Monitoring" }),
        " (System Settings → Privacy & Security) — grant it, then re-arm. If the controller stops responding, switch back to ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("b", { children: "SDL" }),
        "."
      ] }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "App paths" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", c: "dimmed", children: 'Used by the "Launch" actions to open the right app.' }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PathRow, { kind: "claudeDesktop", label: "Claude Desktop", value: config.paths.claudeDesktop }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PathRow, { kind: "terminal", label: "Terminal", value: config.paths.terminal })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { withBorder: true, padding: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { justify: "space-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { order: 4, children: "Permissions" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            variant: "subtle",
      ...
      checking && !perms && /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { size: "xs" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", c: "dimmed", children: "Checking…" })
      ] }),
      perms && !isMac2 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Alert, { color: "green", variant: "light", children: [
        "No extra permission required on ",
        perms.platform,
        "."
      ] }),
      perms && isMac2 && perms.accessibility && /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { color: "green", variant: "light", children: "Accessibility granted" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", c: "dimmed", children: "ClaudePad can control input." })
      ] }),
      needsAccessibility && /* @__PURE__ */ jsxRuntimeExports.jsx(Alert, { color: "yellow", variant: "light", title: "Accessibility not granted", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: "sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", children: "ClaudePad can't send keystrokes until you enable it under Privacy & Security → Accessibility." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "subtle", loading: checking, onClick: () => void checkPermissions(), children: "Re-check" })
        ] })
      ] }) })
    ] }) })
  ] });
}
const shell = "_shell_1o2ug_1";
const nav = "_nav_1o2ug_7";
const brand = "_brand_1o2ug_16";
const brandMark = "_brandMark_1o2ug_23";
const navLinks = "_navLinks_1o2ug_36";
const navItem = "_navItem_1o2ug_42";
const navItemActive = "_navItemActive_1o2ug_61";
const navFooter = "_navFooter_1o2ug_71";
const content = "_content_1o2ug_78";
const topbar = "_topbar_1o2ug_83";
const statusDot = "_statusDot_1o2ug_96";
const contentInner = "_contentInner_1o2ug_109";
const classes = {
  shell,
  nav,
  brand,
...
function App() {
  ...
  const [route, setRoute] = reactExports.useState("tester");
  ...
  if (loading || !config || !activeProfile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Center, { mih: "100vh", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { align: "center", gap: "sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Loader, { color: "clay" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { c: "dimmed", size: "sm", children: "Loading ClaudePad…" })
    ] }) });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.shell, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: classes.nav, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.brand, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.brandMark, children: "CP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { fw: 700, children: "ClaudePad" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: classes.navLinks, children: NAV_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          className: `${classes.navItem} ${route === item.route ? classes.navItemActive : ""}`,
          onClick: () => setRoute(item.route),
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { gap: 0, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", fw: 600, component: "span", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "xs", c: "dimmed", component: "span", children: item.hint })
          ] })
        },
        item.route
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.navFooter, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Group, { gap: "xs", wrap: "nowrap", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            color: runtime.connected ? "green" : "gray",
            variant: "dot",
            styles: { root: { textTransform: "none" } },
            children: runtime.connected ? runtime.controllerName ?? "Controller" : "No controller"
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Badge,
          {
            ...
            fullWidth: true,
            children: config.enabled ? "Mapping on" : "Mapping off"
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: classes.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.topbar, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Group, { gap: "sm", wrap: "nowrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: classes.statusDot,
              "data-connected": runtime.connected || void 0,
              "aria-hidden": true
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { size: "sm", fw: 500, children: runtime.connected ? runtime.controllerName ?? "Controller connected" : "No controller" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Tooltip,
          {
            label: runtime.armed ? "Armed — your controller drives your OS globally, even when ClaudePad is in the background." : "Disarmed — the controller is read but no input is sent. Turn on to drive Claude and your OS.",
            withArrow: true,
            multiline: true,
            w: 280,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: classes.contentInner, children: [
        route === "tester" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          TesterPage,
          {
            state,
            connected,
            ...
            armed: runtime.armed,
            onSetArmed: setArmed,
            onSensitivityChange: (patch) => updateProfile((p2) => ({
              ...p2,
              sensitivity: { ...p2.sensitivity, ...patch }
            }))
          }
        ),
        route === "mapper" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          MapperPage,
          {
            profile: activeProfile,
...
createRoot(container).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(MantineProvider, { theme, defaultColorScheme: "dark", children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
